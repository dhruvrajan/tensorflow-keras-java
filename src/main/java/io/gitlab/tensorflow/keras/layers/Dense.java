...
import io.gitlab.tensorflow.keras.activations.Activation;
import io.gitlab.tensorflow.keras.activations.Activations;
import io.gitlab.tensorflow.keras.initializers.Initializer;
import io.gitlab.tensorflow.keras.initializers.Initializers;
import io.gitlab.tensorflow.keras.mixin.KerasType;
import io.gitlab.tensorflow.keras.utils.TensorShape;
...
public class Dense extends Layer<Float> implements KerasType<Float> {
    ...
    private Dense(int units, Activation<Float> activation, Initializer<Float> kernelInitializer, Initializer<Float> biasInitializer) {
        super(DENSE_INPUT_LENGTH);
        this.units = units;
    ...
    public static class Options {
        ...
        public Options setActivation(Activations activation) { this.activation = activation; return this; }

        public Options setKernelInitializer(Initializers kernelInitializer) { this.kernelInitializer = kernelInitializer; return this; }

        public Options setBiasInitializer(Initializers biasInitializer) { this.biasInitializer = biasInitializer; return this; }
