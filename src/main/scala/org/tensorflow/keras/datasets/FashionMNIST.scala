...
object FashionMNIST {
  ...
  private val LOCAL_PREFIX  = "datasets/fashion_mnist/"
  ...
  @throws[IOException]
  def download(): Unit = {
    DataUtils.getFile(LOCAL_PREFIX + TRAIN_IMAGES, ORIGIN_BASE + TRAIN_IMAGES, fileHash = "8d4fb7e6c68d591d4c3dfef9ec88bf0d", DataUtils.Checksum.md5)
    DataUtils.getFile(LOCAL_PREFIX + TRAIN_LABELS, ORIGIN_BASE + TRAIN_LABELS, fileHash = "25c81989df183df01b3e8a0aad5dffbe", DataUtils.Checksum.md5)
    DataUtils.getFile(LOCAL_PREFIX + TEST_IMAGES , ORIGIN_BASE + TEST_IMAGES , fileHash = "bef4ecab320f06d8554ea6380940ec79", DataUtils.Checksum.md5)
    DataUtils.getFile(LOCAL_PREFIX + TEST_LABELS , ORIGIN_BASE + TEST_LABELS , fileHash = "bb300cfdad3c16e7a12a480ee83cd310", DataUtils.Checksum.md5)
  }
